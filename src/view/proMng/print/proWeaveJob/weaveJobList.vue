 ...
 * @LastEditTime: 2022-07-11 11:53:52
 * @Description: 
-->
<template>
  <div id="clothFlyPrint" v-loading="wloading" element-loading-text="拼命加载中...">
      ...
      <el-dialog id="colorMng_Dlg" :visible.sync="dialogVisible" fullscreen width="100%" append-to-body :close-on-click-modal="false" :close-on-press-escape="false" v-if="dialogVisible">
        <tem-dlg ref="tem" :detail="detail" :isAdd="isAdd" :isExtract="isExtract" :extractRows="extractRows" :copyC="copyC" :splitW="splitW" :audit="false" @close="dialogVisible = false" @refresh="query" v-if="dialogVisible"></tem-dlg>
      </el-dialog>
