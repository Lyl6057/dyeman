    ...
    <el-tabs v-model="tabs" type="border-card">
      <el-tab-pane name="rc" :label="$t('iaoMng.rcgl')">
        ...
        <div class="main tabs1">
          ...
          <!-- <el-row>
            <el-col :span="3">
              <div v-for="item in rc.option1" :key="item.index"></div>
              <el-card shadow="always" class="whse-menuCard">
                <i class="el-icon-edit"></i> <span>纱线入仓</span>
              </el-card>
...
<script>
import { getPurApplication } from "@/api/index";
...
export default {
      ...
      outList: [
        {
          ...
          data: [
            ...
            },
            {
              id: "1-2",
              click: () => {
                this.toView("cc_productionUse", this.$t("iaoMng.sx") + "_1");
              },
            ...
            },
            {
              id: "1-3",
              click: () => {
                this.toView("cc_sx", this.$t("iaoMng.wfjgscc") + "_2");
              },
        ...
        },
        {
          ...
          data: [
            ...
            },
            {
              id: "2-3",
              click: () => {
                this.toView("cc_pb", this.$t("iaoMng.wfjgpbcc") + "_2");
              },
        ...
        },
        {
          ...
          data: [
            ...
            },
            {
              id: "4-3",
              click: () => {
                this.toView("cc_scfl", this.$t("iaoMng.wfjgflcc") + "_2");
              },
        ...
        },
        {
          ...
          data: [
            ...
            // },
            {
              id: "8-2",
              click: () => {
                this.toView("cc_rl", this.$t("iaoMng.sclyrhcc") + "_1");
              },
  ...
  created() {
    // getPurApplication({ collectSucceed: 0 }).then((res) => {
