...
<template>
  <div id="return-yarn-container" >
    <el-tabs v-model="tabName" type="border-card">
      <el-tab-pane name="whseIn" label="本厂余纱退场">
          <whse-in ref="whseInRef" @click-row="handleClickYarnInRow"></whse-in>
      </el-tab-pane>
      <el-tab-pane name="whseUnIn" label="未入仓本厂余纱退仓资料">
          <whse-un-in ref="whseUnInRef" @select="handleSelect"></whse-un-in>
      </el-tab-pane>
    </el-tabs>

    <el-dialog :visible.sync="whseYarnInDtlVisible" fullscreen append-to-body :modal-append-to-body="false">
...
export default {
    ...
    methods:{
      ...
      // 退纱通知单回调选择
      async handleSelect(withDrawalNo){
        this.tabName = "whseIn",
        this.whseYarnInDtlVisible = true;
        await this.$nextTick();
