 ...
 * @LastEditors: Lyl
 * @LastEditTime: 2022-09-12 09:59:47
 * @Description: 
-->
<template>
  <div id="finalCard">
...
export default {
  ...
  methods: {
    ...
    vaildSaveBefore() {
      ...
      if(weightUnit == 'KG'){
        return netWeight + paperTube + qcTakeOut == grossWeight;
      }else{
        return netWeightLbs + paperTube + qcTakeOut == grossWeightLbs;
      }
    },
    getLog() {
      getStorageLog({
