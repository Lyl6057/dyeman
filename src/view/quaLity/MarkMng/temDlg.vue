 ...
 * @LastEditors: Lyl
 * @LastEditTime: 2021-09-16 08:06:56
 * @Description: 
-->
<template>
  <div id="ldOrderDlg">
  ...
  methods: {
    ...
    choiceData(val) {
      ...
      if (this.choiceTle == "选择染整工单") {
        ...
        this.form.sideFabWidth = Number(val.breadthBorder.split("(")[0]);
        this.form.realFabWidth = Number(val.breadthActual.split("(")[0]);
        this.form.beforeGramWeight = Number(val.gramWeightBefor.split("(")[0]);
        this.form.afterGramWeight = Number(val.gramWeightAfter.split("(")[0]);
      } else {
        this.form.colorName = val.colorName;
