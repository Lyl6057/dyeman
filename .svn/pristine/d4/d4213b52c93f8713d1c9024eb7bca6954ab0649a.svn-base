  ...
  <basicContainer id="Quality">
    <div class="Quality">
      ...
      <div class="head-left">
        <el-row>
          ...
          <el-dialog :title="title" :visible.sync="dialog" width="60%">
            ...
            <el-row>
              <el-col>
                <div style="width:90%;margin: 30px 0 0  0">{{ $t("energy.flms") }}</div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="24">
            ...
            <span slot="footer" class="dialog-footer">
              <el-button @click="dialog = false">{{ $t("energy.qx") }}</el-button>
        ...
        <el-dialog :title="title" :visible.sync="kindialog" width="60%">
          <el-row>
            <el-col :span="12">
              <div>
                种类名称
                <el-input v-model="kindName" placeholder="请输入种类名称" style="width:76%"></el-input>
              </div>
            </el-col>
            <el-col :span="12">
              <div>
                序号
                <el-input v-model="kindSn" placeholder="请输入序号" style="width:80%"></el-input>
              </div>
            </el-col>
          </el-row>
          <span slot="footer" class="dialog-footer">
            <el-button @click="kindialog = false">取消</el-button>
            <el-button type="primary" style="display:none;" id="kinsun" @click="fn_kindAdd">保存</el-button>
            <el-button type="primary" style="display:none;" id="kinmon" @click="fn_kindup">修改</el-button>
          </span>
        </el-dialog>
      </div>
      ...
      <el-row v-if="tbData.length>0" class="tbBtn">
        <el-col :span="24">
          <el-button type="primary" v-if="!isCell" @click="Editor">编辑</el-button>
          <el-button type="primary" v-else :disabled="!canSave" @click="Update">保存</el-button>
          <el-button type="primary" :disabled="!isCell" @click="Cancel">取消</el-button>
        </el-col>
      </el-row>
      ...
      <div class="tbBox">
        ...
        <el-row style="margin-top:-1px;">
          ...
          >
            <div class="pzStyle" v-if="checkPz!=''&&tbData.length>0" :style="pzStyle">
              <el-col style="line-height:30px" :style="pzStyles">{{checkPz}}</el-col>
              <el-col class="handleDl" v-if="pzAdd" style="margin:-15% 15% 0 0;">
                <el-row>
          ...
          <el-col :span="22">
            <el-row class="content" v-for="(item,index) of tbData" :key="index">
              <el-col
                :span="2"
                :style="tbStyle[index]"
                style="border-right:1px solid #ccc;line-height:40px;height:40px;"
              >
                <span>{{item.sn}}</span>
              </el-col>
              <!-- 检测项目 -->
                ...
                <div v-if="!isCell">
                  <el-row>
                    ...
                    <el-col class="handleDl" v-if="!item.readonly">
                      <div style="margin-top:-30%;height:20px" @click="addBtnClick(item,'project')">
                        <i class="el-icon-plus"></i>
                      </div>
                      ...
                      <el-row v-if="item.qcItemStandardList.length > 0">
                        ...
                        >
                          ...
                          <el-col class="handleDl" v-if="!items.readonly">
                            ...
                            <div style="height:20px" @click="delBtnClick(items,'standard')">
                              <i class="el-icon-close"></i>
                            </div>
                          </el-col>
                          <el-input
                        ...
                        <el-col :span="12">
                          <el-row>
                            ...
                            <el-col :span="12">
                              ...
                              >
                                <el-row>
                                  <el-col :span="24" class="cdiv" v-if="!isCell">
                                  ...
                                  <el-input
                                    ...
                                    @input="iptChange(data,'size')"
                                  ></el-input>
                                  <el-col class="handleDl" v-if="data.cell" style="margin-right:5%">
                                    <!-- <div
                        ...
                        <el-col
                          ...
                          class="nullStyle"
                          style="border-right:1px solid #ccc;margin-left:0.5px"
                        >/</el-col>
                      </el-row>
                    </div>
                    <div v-if="item.qcItemStandardList.length===0">
                      <el-row>
                        <el-col :span="12" class="nullStyle" style="margin-left:-1px">
                          <div class="cdiv">/</div>
                        </el-col>
                        <el-col :span="6">
                          <div class="nullStyle">
        ...
        <!-- 新增弹窗 -->
        <el-row>
          <el-dialog :visible.sync="itemDialog" width="80%" :close-on-click-modal="false">
            ...
            <el-row>
              <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-tab-pane label="检测项目" name="pz" v-if="activeName == 'pz'">
                  <el-row>
                    <avue-form
                      ref="project"
                      v-model="project"
                ...
                <el-tab-pane label="参考方法标准" name="project" v-if="activeName == 'project'">
                  <el-row>
                    <avue-form
                      ref="standard"
                      v-model="standard"
                ...
                <el-tab-pane label="规格/接受标准" name="standard" v-if="activeName == 'standard'">
                  <el-row>
                    <avue-form ref="size" v-model="size" :option="sizeOp" @submit="sizeSub" />
                  </el-row>
                </el-tab-pane>
                <el-tab-pane label="规格/接受标准" name="size" v-if="activeName == 'size'">角色管理</el-tab-pane>
              </el-tabs>
            </el-row>
          </el-dialog>
        </el-row>
