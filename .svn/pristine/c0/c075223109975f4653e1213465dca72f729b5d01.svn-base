            ...
            >
              ...
              >
                ...
                >
                  ...
                  <!--  width: (gt.lg * gt.finishProportion * dayW) / 24 + 'px', -->
                  <div
                    class="schedule"
                    :style="{
                      width: gt.finishProportion * 100 + '%',
                      height: ganttH + 'px',
                      'line-height': ganttH + 'px',
                    }"
                  >
                  ...
                  <div
                    ...
                    :key="j"
                    :style="{
                      width: (detail.lg * dayW) / 24 + 'px',
                      'margin-top': ganttH + 'px',
                      'box-shadow': gt.choose
                        ? '0 0 10px rgba(81, 203, 238, 1)'
                        : 'none',
                      'padding-left': (detail.ml * dayW) / 24 - 1 + 'px',
                    }"
                  >
                    ...
                    <div class="detail">
                      ...
                      <el-collapse-transition>
                        <div
                          ...
                          v-show="detail.show"
                          :style="{
                            'margin-left': -(detail.ml * dayW) / 24 + 10 + 'px',
                          }"
                        >
                          <div
                            class="lv2Box"
                            ...
                            >
                              <div
                                ...
                                :title="
                                  lv2Task.workName +
                                  ', 共' +
                                  lv2Task.exampleUseTime +
                                  'h'
                                "
                              >
                                {{ lv2Task.workName }}
                                <span style="font-size: 13px">{{
                                  "共" + lv2Task.exampleUseTime + "h"
                                }}</span>
                                <!-- <br />
      ...
      order: [
        {
          ...
          poNo: "PO20201013",
          cust: "优衣库",
          orderData: "2020-10-13",
          weight: 500,
          start: "2020-10-07 09:00:00",
        ...
        },
        {
          ...
          poNo: "PO20201015",
          cust: "优衣库",
          orderData: "2020-10-15",
          weight: 600,
          jd: 0.8,
          start: "2020-10-15 12:00:00",
          end: "2020-11-05 12:00:00",
          show: false,
          orderDetail: [
            {
              // 颜色
        ...
        },
        {
          ...
          cust: "斯凱奇",
          jd: 0.75,
          orderData: "2020-10-18",
          weight: 500,
          start: "2020-10-20 12:00:00",
          end: "2020-11-01 12:00:00",
          show: false,
          orderDetail: [
            {
              // 颜色
        ...
        this.order.forEach((item, i) => {
          ...
          task.forEach((tk) => {
            let time = 0,
              zhTime = 0;
            tk.list.forEach((tkf) => {
              time += tkf.exampleUseTime;
              zhTime += tkf.exampleUseTime * tkf.finishProportion;
              sunTime += tkf.exampleUseTime;
              useTime += tkf.exampleUseTime * tkf.finishProportion;
            });
            zhList.push({
              ...
              taskList.forEach((tl, j) => {
                ...
                px.proSalScheduleDetail.forEach((pl, k) => {
                  if (tl.workName === pl.workName) {
                    // px.taskList ? px.taskList.push(pl) : (px.taskList = [pl]);
                    data.push(pl);
                    kctr = false;
          ...
          item.proSalSchedule.forEach((pd) => {
            pd.lg =
              (new Date(pd.schEnd).valueOf() -
                new Date(pd.schStart).valueOf()) /
              (1000 * 3600);
            pd.ml =
              (new Date(pd.schStart).valueOf() -
          ...
          this.gant.push({
            ...
            h: 2,
            finishProportion:
              item.finishProportion / item.proSalSchedule.length,
            choose: false,
            ...
            label:
              ...
              ",  " +
              "  完成 " +
              (item.finishProportion / item.proSalSchedule.length) * 100 +
              "%",
          });
