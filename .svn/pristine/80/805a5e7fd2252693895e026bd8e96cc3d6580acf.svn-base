  ...
  inserted(el) {
    ...
    el.onmousedown = function (e) { // 鼠标按下
      ...
      el.onmousemove = function (e) { // 鼠标移动
        ...
        if (e.pageX - disx < 0) { // 当小于 最小值 = 0
          el.style.marginLeft = '0px'
        } else if (e.pageX - disx >= maxW) { // 当大于 最大值 = maxW
      ...
      el.onmouseout = function () { // 鼠标离开dom
        el.onmousemove = document.onmouseup = null
      }
      el.onmouseup = function () { // 鼠标松开
